...
parser.add_argument('--audio_directory', type=str, default="/sdb/data1/benchmark/muchin/muchin-audio", help='/Your/path/to/muchin/muchin-audio ')
parser.add_argument('--lyric_directory', type=str, default="/sdb/data1/benchmark/muchin/dataset/bm-data", help='/Your/path/to/muchin/dataset/bm-data')
parser.add_argument('--output_audio_directory', type=str, default="/sdb/data1/benchmark/muchin/muchin_split", help='/Your/path/to/save/split/audio')
parser.add_argument('--output_json_file', type=str, default="/sdb/data1/benchmark/muchin/muchin_ctc1.json", help='/Your/path/to/save/json_file.json')
...
if __name__ == "__main__":
    process_audio_directory(args.audio_directory, args.lyric_directory, args.output_audio_directory, args.output_json_file)