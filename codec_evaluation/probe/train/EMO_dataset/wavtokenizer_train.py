...
@hydra.main(config_path=f"{root_path}/probe/config/EMO_dataset", config_name="wavtokenizer.yaml", version_base=None) # 需要更改
def main(config: DictConfig) -> None:
    ...
    logger.info(f"arousal_r2: {model.test_step_outputs['arousal_r2']}")
    logger.info(f"valence_r2: {model.test_step_outputs['valence_r2']}")
