...
from codec_evaluation.probe.dataset.ESC50_dataset.ESC50_dataset import ESC50dataModule


root_path = codec_evaluation.__path__[0]
logger = RankedLogger(__name__, rank_zero_only=True)

@hydra.main(config_path=f"{root_path}/probe/config/ESC50_dataset", config_name="speechtokenizer.yaml", version_base=None) # 需要更改
