...
from codec_evaluation.probe.dataset.MTG_dataset.MTGGenre_dataset import MTGGenredataset

root_path = codec_evaluation.__path__[0]
logger = RankedLogger(__name__, rank_zero_only=True)

@hydra.main(config_path=f"{root_path}/probe/config/MTG_dataset/MTGGenre_dataset", config_name="semanticodec.yaml", version_base=None) # 需要更改
