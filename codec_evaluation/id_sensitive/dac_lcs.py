...
# [1, 8, 701]
i1, _ = dac1(sig1, length=None)
emb1_id = dac1.model.quantizer.from_codes(i1.movedim(-1, -2))[2]

i2, _ = dac2(sig2, length=None)
emb2_id = dac2.model.quantizer.from_codes(i2.movedim(-1, -2))[2]
