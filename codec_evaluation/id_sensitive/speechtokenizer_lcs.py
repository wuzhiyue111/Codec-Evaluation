...
speechtokenizer1 = init_codec(
    modelname='speechtokenizer',
...
# [1, 8, 468]
i1, _= speechtokenizer1(sig1, length=None)
emb1_id = i1.movedim(-1, -2)

i2, _= speechtokenizer2(sig2, length=None)
